...
class Crime:
    ...
    def __init__(self):
        ...
        self.pop = pd.read_excel("../../../static/data/dam/ml/pop_in_seoul.xls", skiprows=[0, 2])[["자치구", "합계", "한국인", "등록외국인", "65세이상고령자"]]
    ...
    def save_police_pos(self):
        ...
        crime.to_pickle("../../../static/save/dam/ml/police_pos.pkl")
    ...
    def save_cctv_pos(self):
        ...
        외국인비율 과 CCTV 상관계수 [[ 1.         -0.13607433] 거의 무시될 수 있는
                                    [-0.13607433  1.        ]]                        
         """
        cctv_pop.to_pickle("../../../static/save/dam/ml/cctv_pos.pkl")
        print(pd.read_pickle("../../../static/save/dam/ml/cctv_pos.pkl"))
    ...
    def save_police_norm(self):
        ...
        police_norm.to_pickle("../../../static/save/dam/ml/police_norm.pkl")
...
def set_json_from_df(fname):
    ...
    ## json으로 쓰기
    df.to_json("../../../static/save/dam/ml/us-states.json", orient='index')




if __name__ == '__main__':
    set_json_from_df("../../../static/data/dam/ml/us-states.json")
